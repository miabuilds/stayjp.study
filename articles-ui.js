...
window.Articles = (function () {
  ...
  function ensureCss() {
    ...
    st.textContent = [
      ...
      '.art-pb.art-radio.on{background:var(--ac,var(--ac));color:#fff;opacity:1}',
      // top bar
      ...
      '.art-back:active{background:rgba(var(--ac-rgb),.1)}',
      ...
      '.art-chip small{font-size:11px;background:var(--ac,var(--ac));color:#fff;border-radius:999px;padding:1px 6px;font-weight:700}.art-chip.on small{background:var(--bg2,#fff);color:var(--tx,#2C2C2C)}.art-chip i{width:12px;height:12px;color:#16a34a}',
      ...
      '.art-para .jlk{cursor:pointer;color:#e8734a;border-bottom:1px dashed rgba(var(--ac-rgb),.35)}',
      ...
      '.art-sp{position:absolute;left:0;top:.45em;width:26px;height:26px;border-radius:50%;border:1.5px solid rgba(var(--ac-rgb),.45);background:none;color:#e8734a;font-size:11px;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;padding:0 0 0 2px}',
      '.art-sp:hover{background:rgba(var(--ac-rgb),.12)}',
      '.art-s.on .art-sp,.art-s.flat .art-sp{background:#e8734a;border-color:#e8734a;color:#fff}',
      // 詞性淡底(可關):動詞=暖橘、形容詞=淡綠、副詞=淡紫;名詞不上色,保持乾淨
      '.art-mask .pos-v{background:rgba(var(--ac-rgb),.16);border-radius:4px}',
      ...
      '[data-theme="dark"] .art-mask .pos-v{background:rgba(var(--ac-rgb),.26);box-shadow:inset 0 -2px 0 rgba(var(--ac-rgb),.55)}',
      ...
      '.art-s.on .aw.cur{background:rgba(var(--ac-rgb),.85);color:#fff;box-shadow:0 0 0 2px rgba(var(--ac-rgb),.5)}',
      '.art-s.on .aw.cur rt{color:rgba(255,255,255,.85)}',
      // 無逐詞時間軸的句子(N5/少數對不齊):退回整句淡底
      '.art-s.on.flat{background:rgba(var(--ac-rgb),.16)}',
      ...
      '.art-v-click:active{background:rgba(var(--ac-rgb),.1)}',
      '.art-v-click:hover{background:rgba(var(--ac-rgb),.05)}',
      '.art-v-spk{border:none;background:rgba(var(--ac-rgb),.14);color:#e8734a;width:38px;height:38px;border-radius:50%;font-size:16px;cursor:pointer;flex-shrink:0;display:inline-flex;align-items:center;justify-content:center}',
      ...
      // 文章 tab 底部內嵌文法區
      '.art-inline-v{margin-top:26px;padding-top:16px;border-top:2px solid rgba(var(--ac-rgb),.4)}',
