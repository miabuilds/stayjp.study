...
(function (root) {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      '#tutorFab .tt-dot{position:absolute;top:-2px;right:-2px;background:var(--ac,var(--ac));color:#fff;font-size:10px;line-height:1;padding:3px 6px;border-radius:10px;font-weight:700}',
      ...
      '#tutorPanel .tt-full{display:block;width:100%;margin-top:8px;background:var(--ac,var(--ac));color:#fff;border:0;border-radius:10px;padding:9px 12px;font:inherit;font-size:13px;font-weight:800;cursor:pointer}',
      ...
      '#tutorPanel .tt-ctx b{color:var(--ac,var(--ac));font-weight:700;flex:none}#tutorPanel .tt-ctx span{flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}',
      ...
      '#tutorPanel textarea:focus{border-color:var(--ac,var(--ac))}',
      '#tutorPanel .tt-send{flex:none;width:40px;height:40px;border-radius:50%;border:none;background:var(--ac,var(--ac));color:#fff;font-size:17px;cursor:pointer;display:flex;align-items:center;justify-content:center}',
