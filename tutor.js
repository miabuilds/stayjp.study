...
(function (root) {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      '#tutorPanel .tt-msgs{flex:1;overflow-y:auto;padding:10px 12px;display:flex;flex-direction:column;gap:10px;-webkit-overflow-scrolling:touch}',
      '#tutorPanel .tt-m{max-width:92%;padding:9px 12px;border-radius:14px;font-size:14px;line-height:1.65;color:var(--tx,#2C2C2C);word-break:break-word}',
      ...
      'body.tutor-open #tutorFab,body.tutor-open #tutorHint{display:none}'
    ].join('\n');
