...
'zh-TW': {
  ...
  // Mock exam
  me_title: 'JLPT 快速小考',
  me_subtitle: '快速測一下手感：文字語彙 + 文法讀解兩小節。想照真題完整刷，請走 JLPT 刷題特區的「完整模擬試験」',
  me_structure: '考試結構',
...
'zh-CN': {
  ...
  me_title: 'JLPT 快速小考',
  me_subtitle: '快速测一下手感：文字语汇 + 语法阅读两小节。想照真题完整刷，请走 JLPT 刷题特区的「完整模拟试验」',
  me_structure: '考试结构',
