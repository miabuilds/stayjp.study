...
// 難度規格:每級給「具體可用/禁用」規則(用戶回饋:原本一句形容詞,N5~N1 聊起來鑑別度不大)。
// 「禁用」比「可用」對模型更有效;句長與資訊量是體感差異最大的兩件事。
const LEVEL_DESC: Record<string, string> = {
  N5: "N5 入門——嚴格遵守:①只用 です/ます體;句型限現在/過去/て形請求(〜てください)/欲求(〜たいです)等 N5 文法。②每句 ≤12 字、你的回覆最多 2 短句,一次只問一件事。③詞彙限 N5 基本詞;難詞換白話(例:「返品」改說「返すこと」再補一句解釋)。④禁用:普通體、敬語(尊敬語/謙譲語)、使役/受身、口語縮約(〜ちゃう/〜とく/〜てる)、慣用句、擬聲擬態語。像對完全初學者慢慢講。",
  N4: "N4 基礎——①です/ます體為主。②可用:て形連接、可能形、〜たら/〜とき/〜たり、簡單授受(あげる/くれる/もらう)。③每句 ≤18 字、回覆最多 2 句。④禁用:尊敬語/謙譲語(いらっしゃる/お〜します 等)、口語縮約、慣用句、N2 以上文法。",
  N3: "N3 中級——①自然日常語速與用詞;丁寧體為主,親近場景(朋友/同事閒聊)可用普通體。②可用:受身/使役、〜そう/〜らしい/〜みたい、常見口語縮約(〜てる/〜ちゃう)、入門慣用語。③回覆 2〜3 句,可加一點細節或追問。④避免:完整敬語體系、書面語、艱澀慣用句。",
  N2: "N2 中上級——①自然流暢的母語者日常日語:複合句、慣用句、擬聲擬態語自然使用。②場景該用敬語就完整用(店員/櫃檯對客人:尊敬語+謙譲語)。③回覆 2〜3 句,資訊量正常,不遷就學習者、不刻意放慢。④可延伸話題、給對方追問空間。",
  N1: "N1 高階——完全母語者等級,不做任何簡化:①間接婉轉的表達、言外之意、客套與社交辭令照常使用(「ちょっと難しいかもしれませんね」式的委婉拒絕)。②敬語完整、口語縮約與省略自然出現(〜んじゃない?/〜かと)。③句子可長、可插入補充;偶爾用進階詞彙與四字熟語。④對方聽不懂時,像真的日本人那樣換個說法,而不是降級成教科書日語。",
};
...
- 難度是硬性規格,不是氛圍:嚴格遵守【對話難度】的可用/禁用清單與句長上限;JP、HINT、開場白全部適用。等級之間要讓人聽得出明顯差異。
